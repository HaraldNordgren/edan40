...
> 
>
> cMajor = foldr1 (:=:) [ Note (x, 4) (hn) [Volume 60] | x<-[C, E, G] ]
...
> calypso = times 2 $ foldr1 (:+:) [qnr, c 3 en [Volume 80], e 3 en [Volume 80]] 
> boogie =  times 2 $ lmap (fd qn) [c 3, a 3, b 3, a 3] 
